...
public class RobotContainer {
    ...
    public final TurretSubsystem sixseven = new TurretSubsystem();
    ...
    private void configureBindings() {
        ...
        joystick.a().whileTrue(new RunShooterCommand(shooter, 5000));
        joystick.x().whileTrue(new TurretAlign(rizz, sixseven));
